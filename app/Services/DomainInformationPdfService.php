...
class DomainInformationPdfService
{
    /**
    ...
    public function renderBinary(array $report, array $meta): string
    {
        ...
        $bodyHtml = view('domain-information.export.pdf-body', $data)->render();
        $margin = 14;
        ...
        $mpdf->SetTitle((string) __('Domain information report'));
        ...
        $coverMeta = array_merge($meta, [
            'cover_rev' => 'domain-information-2',
            'cover_kicker' => (string) __('Domain information report'),
            'cover_title' => (string) __('Tracking the domain registration period'),
            'cover_lead' => (string) __('Domain information report cover lead'),
            'cover_footer' => (string) __('Domain information report'),
        ]);
        ...
        $reportTitle = htmlspecialchars((string) __('Domain information report'), ENT_QUOTES, 'UTF-8');
